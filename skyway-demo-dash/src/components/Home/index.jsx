function Home() {
  ...
  const text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc eu ultricies mauris, at facilisis quam. Vivamus et tellus facilisis, vehicula nunc a, fermentum ipsum. ";
